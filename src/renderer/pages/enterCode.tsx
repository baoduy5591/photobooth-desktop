      ...
      <div className='absolute inset-0 flex flex-col items-center'>
        ...
        <div className='mt-10'>
          ...
          <div className='h-[115px] w-[768px] -translate-y-5'>
            <InputStyle1
              iconCamera={store.pathFolderAssets + store.resources.icons[12]?.relPath}
              iconBling={store.pathFolderAssets + store.resources.icons[13]?.relPath}
              iconFail={store.pathFolderAssets + store.resources.icons[16]?.relPath}
        ...
        <div className='mt-8 h-[480px] w-[450px]'>
          <KeyboardNumber
            ...
            iconTrash={store.pathFolderAssets + store.resources.icons[14]?.relPath}
            iconBack={store.pathFolderAssets + store.resources.icons[15]?.relPath}
            iconBling={store.pathFolderAssets + store.resources.icons[13]?.relPath}
          />
        </div>
      </div>
