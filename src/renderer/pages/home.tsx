    ...
    <div className='relative h-screen w-screen'>
      ...
      {isOpenModal && (
        <div
          ...
          className='absolute left-1/2 top-1/2 z-10 mt-3 h-[538px] w-[838px] -translate-x-1/2 -translate-y-1/2 rounded-md border-4 border-dashed border-custom-pink bg-white p-2'
        >
