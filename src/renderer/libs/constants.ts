...
export const CONST_FRAME_POSITIONS: FramePositionType = {
  ...
  wide: {
    typeA: [
      [{ x: 40, y: 49, w: 1160, h: 392 }],
      [{ x: 40, y: 460, w: 1160, h: 392 }],
      [{ x: 40, y: 870, w: 1160, h: 392 }],
      [{ x: 40, y: 1280, w: 1160, h: 392 }],
    ],
    typeB: [
      [{ x: 40, y: 49, w: 1160, h: 540 }],
      [{ x: 40, y: 607, w: 1160, h: 540 }],
      [{ x: 40, y: 1165, w: 1160, h: 540 }],
    ],
  },
};
