...
export const CONST_FRAME_POSITIONS: FramePositionType = {
  ...
  wide: {
    typeA: [
      [{ x: 41, y: 50, w: 1160, h: 392 }],
      [{ x: 41, y: 461, w: 1160, h: 392 }],
      [{ x: 41, y: 871, w: 1160, h: 392 }],
      [{ x: 41, y: 1281, w: 1160, h: 392 }],
    ],
    typeB: [
      [{ x: 41, y: 50, w: 1160, h: 540 }],
      [{ x: 41, y: 608, w: 1160, h: 540 }],
      [{ x: 41, y: 1166, w: 1160, h: 540 }],
    ],
  },
};
